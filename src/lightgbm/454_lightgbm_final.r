...
PARAM$experimento <- "KA4540-ho" #hiperparametros optimos
...
PARAM$finalmodel$num_iterations <- 400
PARAM$finalmodel$learning_rate <- 0.0424367066695989
PARAM$finalmodel$feature_fraction <- 0.357101930659852
PARAM$finalmodel$min_data_in_leaf <- 56
PARAM$finalmodel$num_leaves <- 674

PARAM$finalmodel$max_depth <- 7
PARAM$finalmodel$min_gain_to_split <- 0.009589633799
PARAM$finalmodel$lambda_l1 <- 0.4792750105
PARAM$finalmodel$lambda_l2 <- 1.075753362
